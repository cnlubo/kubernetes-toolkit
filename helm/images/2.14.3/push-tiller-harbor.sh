...
docker login $harbor_host
docker tag gcr.io/kubernetes-helm/tiller:v$tiller_version \
${my_registry}/gcr-io-kubernetes-helm-tiller:v$tiller_version
echo ""
echo "=========================================================="
echo "push images into harbor ..... "
echo ""
docker push ${my_registry}/gcr-io-kubernetes-helm-tiller:v$tiller_version
echo ""
echo "=========================================================="
