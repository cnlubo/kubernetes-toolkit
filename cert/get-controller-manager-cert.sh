...
[ -d /opt/k8s/certs/kube-controller-manager ] && rm -rf /opt/k8s/certs/kube-controller-manager
mkdir -p /opt/k8s/certs/kube-controller-manager
cd /opt/k8s/certs/kube-controller-manager || exit
info "create kube-controller-manager-csr.json ....."
