...
# @Author: cnak47
 ...
 # @LastEditors: cnak47
 # @LastEditTime: 2019-08-14 21:53:52
 # @Description: 
 ###
...
[ -d /opt/k8s/certs/etcd ] && rm -rf /opt/k8s/certs/etcd
mkdir -p /opt/k8s/certs/etcd
cd /opt/k8s/certs/etcd || exit
info "create  etcd-csr.json ....."
