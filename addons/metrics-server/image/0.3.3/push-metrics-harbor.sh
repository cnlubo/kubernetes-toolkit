...
docker tag k8s.gcr.io/metrics-server-amd64:v0.3.3 \
 ${my_registry}/k8s-gcr-io-metrics-server-amd64:v0.3.3
...
echo ""
docker push ${my_registry}/k8s-gcr-io-metrics-server-amd64:v0.3.3
